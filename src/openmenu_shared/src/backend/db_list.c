...
/* Returns 0 on success and places a pointer in item, otherwise returns 1 and
 * item = NULL */
int
db_get_meta(const char* id, struct db_item** item) {
...
const char*
db_format_nplayers_str(int nplayers) {
    static char str[10];
...
const char*
db_format_vmu_blocks_str(int num_blocks) {
    static char str[12];
