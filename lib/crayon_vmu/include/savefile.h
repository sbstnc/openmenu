...
uint8_t crayon_savefile_check_for_save(crayon_savefile_details_t* savefile_details, int8_t savefile_port,
                                       int8_t savefile_slot);                          //1 if save DNE. 0 if it does
...
int16_t crayon_savefile_get_save_block_count(
    crayon_savefile_details_t* savefile_details); //Returns the number of blocks your save file will need (Uncompressed)
...
uint8_t crayon_savefile_load_eyecatch(crayon_savefile_details_t* savefile_details,
                                      char* eyecatch_path); //Also sets eyecatch_type
...
uint8_t crayon_savefile_init_savefile_details(crayon_savefile_details_t* savefile_details, uint8_t* savefile_data,
                                              size_t savefile_size, uint8_t icon_anim_count, uint16_t icon_anim_speed,
                                              const char* desc_long, const char* desc_short, const char* app_id,
